                ...
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            Enhance your coding expertise with advanced topics and real-world projects. Ideal for seasoned developers looking to deepen their knowledge and tackle complex challenges.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                            Gain insights from leading Google Developer Group (GDG) and Google Developer Experts (GDE) as they share cutting-edge knowledge and industry trends. Ideal for tech enthusiasts looking to stay ahead of the curve.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                ...
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                            The GDSC Networking Mixer aims to connect students, developers, and tech enthusiasts with industry professionals and like-minded peers. This event provides an opportunity for attendees to build valuable connections, share knowledge, and explore potential collaborations.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                    </div>
